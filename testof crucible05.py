...
partsCostCell = float(partsCost_entry1) + float(partsCost_entry2) + float(partsCost_entry3) + float(partsCost_entry4) + float(partsCost_entry5)
ws.Cells(31, 17).Value = partsCostCell  
ws.Cells(32, 15).Value = 80*float(laborCell) + float(partsCostCell)
